  ...
  return (
    <Stack>
      <Flex
        ...
        alignSelf="center"
      >
        <Box mt={isNotSmallScreen ? "0" : 16} display="flex" justifyContent="center" alignItems="center" flexDir="column">
          <Image
            alt="Francisco Lucca"
            borderRadius="full"
            boxSize="350px"
        ...
        <Box ml={isNotSmallScreen ? "150px" : "0"} mt={isNotSmallScreen ? "0" : 16} display="flex" justifyContent="center" alignItems="flex-start" flexDir="column">
